...
constexpr float BULLET_TIME_COST = 0.3f;
constexpr float TOTAL_TIME = 300.0f;
constexpr float ENEMY_BASE_SPEED = 100.0f;
constexpr float SPAWN_INTERVAL_START = 1.5f;
constexpr float SPAWN_INTERVAL_MIN = 0.3f;
constexpr float SHAKE_DURATION = 0.1f;
